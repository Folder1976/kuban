...
$(function() {
    function e(e, s) {
        s.removeClass("is-active"), e && e.addClass("is-active")
    }
    $(".nav-list__item").children("ul").hide(), $(document).on("mouseover", ".nav-list__item", function() {
    ...
    }), $("[data-fancybox]").fancybox(), $(".zoom-item").zoom({
        magnify: "1.5"
        ...
        return $.ajax({
            ...
            setTimeout(function() {
                e.trigger("reset"), $(e).find(".button").addClass("success-active"), $(".button").fancybox()
            }, 1e3)
        }), !1
    });
    var s = $(".js-faq-accordion-wrap"),
        i = $(".js-faq-accordion-title"),
        t = $(".js-faq-accordion-content");
    i.each(function(i, o) {
        $(o).on("click", function() {
            var i = $(this),
                o = $(i).closest(s),
                n = o.find(t);
            !o.hasClass("is-active") && n.length ? (t.slideUp(300), n.slideDown(300), e(o, s)) : (n.slideUp(300), e(null, o))
        })
    })
});